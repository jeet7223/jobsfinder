...
time.sleep(3)
driver.find_element(by=By.NAME, value='session_key').send_keys("munjanikhushi862@gmail.com")
time.sleep(2)
driver.find_element(by=By.NAME, value='session_password').send_keys("khushi22")
time.sleep(2)
